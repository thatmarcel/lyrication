...
#import "../View/HWDimmedView.h"
#import "../View/HWPanContainerView.h"
#import "../Presentable/UIViewController+LayoutHelper.h"
#import "../Animator/HWPanModalAnimator.h"
#import "../Animator/HWPanModalInteractiveAnimator.h"
#import "../Delegate/HWPanModalPresentationDelegate.h"
#import "../Presenter/UIViewController+PanModalPresenter.h"
#import "../View/HWPanIndicatorView.h"
#import "../Category/UIView+HW_Frame.h"
#import "../Mediator/HWPanModalPresentableHandler.h"
...
- (void)presentationTransitionWillBegin {
	...
	[self.presentedViewController.transitionCoordinator animateAlongsideTransition:^(id <UIViewControllerTransitionCoordinatorContext> context) {
        ...
        if ([[self presentable] allowsTouchEventsPassingThroughTransitionView]) {
            // hack TransitionView
            [self.containerView setValue:@(YES) forKey:@"ignoreDirectTouchEvents"];
        }
    }];
	...
	if (!_backgroundView) {
        ...
        if ([[self presentable] allowsTouchEventsPassingThroughTransitionView]) {
            ...
            _backgroundView.tapBlock = ^(UITapGestureRecognizer *recognizer) {
                if ([[self presentable] allowsTapBackgroundToDismiss]) {
